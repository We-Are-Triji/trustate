...
import { Home, MessageSquare, FileText, Wallet, Bot, Lock, Menu, X, ChevronRight, ChevronLeft } from "lucide-react";
...
export function TransactionMenu({ activeTab, onTabChange, transactionId, projectName = "Unit 101 - Avida", lockedTabs = [], onClose }: TransactionMenuProps) {

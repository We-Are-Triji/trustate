...
import { Home, MessageSquare, FileText, Wallet, Bot, Lock, Menu, X, ChevronRight, ChevronLeft, Settings, Activity, UserCheck, PenTool } from "lucide-react";
...
const menuItems: MenuItem[] = [
  ...
  { id: "signing", label: "Document Signing", icon: PenTool },

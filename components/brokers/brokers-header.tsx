...
export function BrokersHeader({
  ...
  return (
    <div className="mb-8">
      ...
      {/* Broker Type Toggle */}
      <div className="mb-6 flex rounded-2xl bg-white/60 backdrop-blur-sm p-2 border border-gray-100 shadow-sm">
        <button
          onClick={() => onBrokerTypeChange("firm")}
          className={`flex flex-1 items-center justify-center gap-2 rounded-xl px-6 py-3.5 text-sm font-bold transition-all duration-300 ${
            brokerType === "firm"

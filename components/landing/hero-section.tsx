...
export function HeroSection({ agents }: HeroSectionProps) {
  ...
  return (
    <section className="relative overflow-hidden min-h-screen max-h-screen flex items-center py-4 lg:py-6 w-screen bg-[#f8faff]">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 w-full py-2">
        <div className="grid gap-8 lg:grid-cols-2 lg:gap-10 items-center mt-8 lg:mt-12">
          ...
          <div className="animate-[slideInLeft_0.8s_ease-out]">
            ...
            <div className="mt-8 max-w-md animate-[fadeInUp_1s_ease-out_0.6s_both]">
              <div className="rounded-3xl bg-gradient-to-br from-[#0247ae] via-[#0560d4] to-[#0873c9] p-5 shadow-2xl shadow-[#0247ae]/40 hover:shadow-[0_30px_70px_-15px_rgba(2,71,174,0.6)] transition-all duration-700 hover:-translate-y-3 hover:rotate-[0.5deg] border border-white/10 backdrop-blur-sm relative overflow-hidden group/comm">
                ...
                <p className="relative mb-4 text-xs font-bold text-white/90 uppercase tracking-widest">Communication Ways</p>
                <div className="relative flex items-center justify-between">
                  <div className="flex gap-2.5">
                    <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-white shadow-xl shadow-white/20 cursor-pointer hover:scale-110 hover:-rotate-6 hover:shadow-2xl transition-all duration-500 group/icon">
                      <Video className="h-5 w-5 text-[#0247ae] group-hover/icon:scale-110 group-hover/icon:text-[#0560d4] transition-all duration-300" />
                    </div>
                    <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-[#ffce08] to-[#f5c000] shadow-xl shadow-[#ffce08]/50 cursor-pointer hover:scale-110 hover:-rotate-6 hover:shadow-2xl hover:shadow-[#ffce08]/60 transition-all duration-500 group/icon">
                      <Phone className="h-5 w-5 text-[#0247ae] group-hover/icon:scale-110 transition-all duration-300" />
                    </div>
                    <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-white/15 backdrop-blur-md border border-white/20 cursor-pointer hover:scale-110 hover:-rotate-6 transition-all duration-500 hover:bg-white/25 hover:border-white/40 group/icon">
                      <MessageCircle className="h-5 w-5 text-white group-hover/icon:scale-110 transition-all duration-300" />
                    </div>
                    <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-white/15 backdrop-blur-md border border-white/20 cursor-pointer hover:scale-110 hover:-rotate-6 transition-all duration-500 hover:bg-white/25 hover:border-white/40 group/icon">
                      <Mail className="h-5 w-5 text-white group-hover/icon:scale-110 transition-all duration-300" />
                    </div>
                  </div>
                  <div className="text-right">
                    <p className="text-xs text-white/80 font-medium">Video Call</p>
                ...
                {/* Active users */}
                <div className="relative mt-4 pt-4 border-t border-white/20 flex items-center justify-between group/users cursor-pointer hover:border-white/30 transition-colors duration-300">
                  <div className="flex -space-x-3">
                    <img src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=100&h=100&fit=crop&crop=face" alt="" className="h-9 w-9 rounded-full border-2 border-white object-cover shadow-lg transition-all duration-500 hover:scale-130 hover:z-10 hover:-translate-y-1 hover:border-[#ffce08]" />
                    <img src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&h=100&fit=crop&crop=face" alt="" className="h-9 w-9 rounded-full border-2 border-white object-cover shadow-lg transition-all duration-500 hover:scale-130 hover:z-10 hover:-translate-y-1 hover:border-[#ffce08]" />
                    <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop&crop=face" alt="" className="h-9 w-9 rounded-full border-2 border-white object-cover shadow-lg transition-all duration-500 hover:scale-130 hover:z-10 hover:-translate-y-1 hover:border-[#ffce08]" />
                    <div className="h-9 w-9 rounded-full bg-gradient-to-br from-[#ffce08] to-[#f5c000] border-2 border-white flex items-center justify-center text-[10px] font-extrabold text-[#0247ae] shadow-lg shadow-[#ffce08]/30 transition-all duration-500 hover:scale-130 hover:rotate-12 hover:z-10 hover:-translate-y-1">
                      +99
                    </div>
                  </div>
                  <div className="transition-transform duration-300 group-hover/users:translate-x-1">
                    <p className="text-xs font-bold text-white">Active Users</p>
                    <p className="text-[10px] text-white/80 font-medium">Join the community</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="relative animate-[slideInRight_0.8s_ease-out]">
            ...
            {/* Main featured card */}
            <div className="relative mx-auto max-w-sm lg:ml-auto lg:mr-8 flex flex-col items-center">
              <div className="overflow-hidden rounded-3xl border-0 bg-white/90 backdrop-blur-xl shadow-2xl hover:shadow-[0_30px_70px_-15px_rgba(0,0,0,0.35)] transition-all duration-700 hover:-translate-y-3 group/card w-full relative">
                  ...
                  {/* Card header */}
                  <div className="relative bg-gradient-to-br from-[#0247ae] via-[#0560d4] to-[#0873c9] pt-5 px-5 pb-14 overflow-hidden">
                    ...
                    {/* Rank badge */}
                    <div className="absolute left-4 top-4 flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-[#ffce08] to-[#f5c000] font-bold text-[#0247ae] shadow-lg shadow-[#ffce08]/40 text-lg transition-all duration-500 group-hover/card:scale-115 group-hover/card:rotate-12 group-hover/card:shadow-xl group-hover/card:shadow-[#ffce08]/60 z-10">
                      {activeAgent.rank}
                    </div>
                    
                    {/* Rating */}
                    <div className="absolute right-4 top-4 flex items-center gap-1.5 rounded-full bg-white/20 backdrop-blur-md px-3 py-1.5 border border-white/20 group-hover/card:bg-white/30 group-hover/card:border-white/40 transition-all duration-500 z-10">
                      <Star className="h-4 w-4 fill-[#ffce08] text-[#ffce08] group-hover/card:scale-125 group-hover/card:rotate-12 transition-all duration-500" />
                      <span className="text-sm font-bold text-white">{activeAgent.rating}</span>
                    </div>
                  </div>
                  ...
                  <div className="relative -mt-12 flex justify-center">
                    <div className="relative group/avatar">
                      <div className="h-24 w-24 rounded-full border-4 border-white shadow-xl overflow-hidden transition-all duration-700 group-hover/card:scale-115 group-hover/card:border-[#ffce08] group-hover/card:shadow-2xl group-hover/card:shadow-[#ffce08]/30">
                        <img 
                      ...
                      {/* Online indicator */}
                      <div className="absolute bottom-0 right-0 h-6 w-6 rounded-full border-2 border-white bg-gradient-to-br from-green-400 to-green-500 flex items-center justify-center group-hover/card:scale-125 transition-all duration-500 shadow-lg shadow-green-500/50">
                        <div className="absolute inset-0 h-6 w-6 rounded-full bg-green-400 animate-ping opacity-60" />
                  ...
                  {/* Agent info */}
                  <div className="px-5 pb-5 pt-3 text-center relative">
                    <h3 className="mb-1 text-lg font-bold text-gray-900 group-hover/card:text-[#0247ae] transition-colors duration-500">{activeAgent.name}</h3>
                    ...
                    <div className="mb-4 flex items-center justify-center gap-1.5 text-xs text-gray-500">
                      <MapPin className="h-4 w-4 text-gray-400 group-hover/card:text-[#0247ae] transition-colors duration-500" />
                      <span className="font-medium">{activeAgent.location}</span>
                    </div>

                    {/* Stats */}
                    <div className="mb-4 grid grid-cols-2 gap-3 rounded-2xl bg-gradient-to-br from-gray-50 via-white to-gray-50 p-4 border border-gray-100 group-hover/card:border-[#0247ae]/20 group-hover/card:shadow-lg group-hover/card:shadow-[#0247ae]/5 transition-all duration-500">
                      <div className="text-center">
                        <p className="text-xl font-bold bg-gradient-to-br from-[#0247ae] to-[#0560d4] bg-clip-text text-transparent">{activeAgent.propertiesSold}</p>
                        <p className="text-[10px] text-gray-500 font-medium">Sold</p>
                      </div>
                      <div className="text-center border-l border-gray-200">
                        <p className="text-xl font-bold bg-gradient-to-br from-[#0247ae] to-[#0560d4] bg-clip-text text-transparent">{activeAgent.totalSalesValue.replace("PHP ", "").replace("M", "")}M</p>
                    ...
                    <Button className="w-full rounded-full bg-gradient-to-r from-[#0247ae] via-[#0560d4] to-[#0247ae] hover:from-[#0560d4] hover:via-[#0247ae] hover:to-[#0560d4] font-semibold h-11 text-sm shadow-lg shadow-[#0247ae]/25 transition-all duration-500 hover:shadow-xl hover:shadow-[#0247ae]/40 hover:scale-[1.03] group bg-[length:200%_100%] hover:bg-[length:100%_100%] overflow-hidden relative">
                      ...
                      <ArrowRight className="relative ml-2 h-5 w-5 transition-all duration-500 group-hover:translate-x-2" />
                    </Button>
                  </div>
                </div>
              </div>
              ...
              {/* Carousel indicators */}
              <div className="mt-5 flex justify-center ml-35 gap-3">
                {topThree.map((_, index) => (
                  <button
                    ...
                    className={`h-3 rounded-full transition-all duration-500 hover:scale-125 ${
                      index === activeIndex 
                        ? "w-10 bg-gradient-to-r from-[#0247ae] to-[#0560d4] shadow-lg shadow-[#0247ae]/40" 
                        : "w-3 bg-gray-300/80 hover:bg-[#0247ae]/50"
                    }`}
      ...
      <div className="absolute bottom-8 right-8 z-40 flex flex-col items-center gap-3 animate-[fadeIn_1s_ease-out_1.2s_both]">
